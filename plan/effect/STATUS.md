...
Only one owner changes a step at a time. Reviewers may add evidence without taking ownership. A step cannot be `complete` while required verification is skipped or residue owned by that step remains. Steps 05-07 may leave the unchanged old application path active only because Step 08 owns the direct atomic cutover and deletion; they may not add compatibility bridges.
...
| [03 Test substrate](./03-build-deterministic-effect-test-substrate.md)                      | `not_started` | unassigned          | 02         | 04-16              | `@effect/vitest`, TestClock, neutral Stream/Deferred controls, resource probes proven                           |
...
| [14 Native observability](./14-add-native-observability-layers.md)                          | `not_started` | unassigned          | 13         | 15-16              | complete Logger/Tracer/Metric instrumentation; privacy/cardinality tests; exporter isolation                    |
