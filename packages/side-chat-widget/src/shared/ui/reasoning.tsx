 ...
 * rotates via the `panelopen:` variant.
 *
 * Open state is controlled so a parent can auto-collapse the fold the moment the
 * answer begins (flip `open` → false) while leaving the trigger user-toggleable.
