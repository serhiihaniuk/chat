...
export const meta = {
  ...
  description: "Greenfield-build every §8 primitive + §9 composition 1:1 from the widget build contract, each shipping a showcase demo section",
  phases: [
...
const MANIFEST_SCHEMA = {
  ...
  properties: {
    ...
    gatesSelfChecked: { type: "boolean", description: "true if G1/G2 greps returned empty on your file" },
    notes: { type: "string", description: "anything the assembler/reviewer should know (deviations, TODOs)" },
  },
};
...
const COMPONENTS = [
  // ===== PRIMITIVES =====
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/switch.tsx", section: "SwitchSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/menu.tsx", section: "MenuSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/scroll-area.tsx", section: "ScrollAreaSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/row.tsx", section: "RowSection",
    partB: [
      ...
      "TWO FORMS to demonstrate: (A) as a Base UI item — state via highlighted: (pointer OR keyboard) and selected: for the check; (B) as a standalone <button> conversation row — state via aria-current: hover:bg-accent + aria-[current=true]:bg-sidebar-accent, trailing dot opacity-0 -> aria-[current=true]:opacity-100.",
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/media.tsx", section: "MediaSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/field.tsx", section: "FieldSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/button.tsx", section: "ButtonSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/segmented.tsx", section: "SegmentedSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/tabs.tsx", section: "TabsSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/select.tsx", section: "SelectSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/combobox.tsx", section: "ComboboxSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/badge.tsx", section: "BadgeSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/tooltip.tsx", section: "TooltipSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/separator.tsx", section: "SeparatorSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ui/collapsible.tsx", section: "CollapsibleSection",
    partB: [
  ...
  { phase: "Primitives", file: "packages/side-chat-widget/src/shared/ai/markdown-content.tsx", section: "MarkdownSection",
    partB: [
  ...
  // ===== COMPOSITIONS =====
  { phase: "Compositions", file: "packages/side-chat-widget/src/shared/ui/conversation-item.tsx", section: "ConversationItemSection",
    partB: [
      "BUILD: §9.1 Conversation item. The standalone <button> form of Row. No Base UI part.",
      "EXPORT: ConversationItem — props { title:string, when:string, active?:boolean, onSelect?:()=>void }. Render exactly the §9.1 snippet: <button aria-current={active || undefined} className=\"flex items-center gap-2.5 w-full px-2.5 py-2 rounded-md text-left hover:bg-accent aria-[current=true]:bg-sidebar-accent\"> with a min-w-0 flex-col column (title: truncate text-sm font-medium text-foreground; subtitle/when: truncate text-xs text-muted-foreground) and a trailing dot <span className=\"ml-auto size-1.5 rounded-full bg-primary opacity-0 aria-[current=true]:opacity-100\"/>. Also ConversationItemSection.",
  ...
  { phase: "Compositions", file: "packages/side-chat-widget/src/shared/ui/conversation-grouping.tsx", section: "ConversationGroupingSection",
    partB: [
  ...
  { phase: "Compositions", file: "packages/side-chat-widget/src/shared/ui/tools-menu.tsx", section: "ToolsMenuSection",
    partB: [
  ...
  { phase: "Compositions", file: "packages/side-chat-widget/src/shared/ui/model-selector.tsx", section: "ModelSelectorSection",
    partB: [
  ...
  { phase: "Compositions", file: "packages/side-chat-widget/src/shared/ui/composer.tsx", section: "ComposerSection",
    partB: [
  ...
  { phase: "Compositions", file: "packages/side-chat-widget/src/shared/ui/message.tsx", section: "MessageSection",
    partB: [
      ...
      "IMPORTANT (G1): the contract snippet shows max-w-[82%] and leading-[1.55] — both are arbitrary values that FAIL G1. Use leading-message (registered) and put the 82% cap in an inline style={{ maxWidth: '82%' }} (inline style is a runtime value, not a className, so it passes the gates). User bubble has ONE squared tail corner (rounded-lg + rounded-br-sm). The assistant has no bubble and caps at max-w-measure-message.",
  ...
  { phase: "Compositions", file: "packages/side-chat-widget/src/shared/ui/message-actions.tsx", section: "MessageActionsSection",
    partB: [
  ...
  { phase: "Compositions", file: "packages/side-chat-widget/src/shared/ui/tool-row.tsx", section: "ToolRowSection",
    partB: [
  ...
  { phase: "Compositions", file: "packages/side-chat-widget/src/shared/ui/reasoning.tsx", section: "ReasoningSection",
    partB: [
  ...
  { phase: "Compositions", file: "packages/side-chat-widget/src/shared/ui/error-notice.tsx", section: "ErrorNoticeSection",
    partB: [
  ...
  { phase: "Compositions", file: "packages/side-chat-widget/src/shared/ui/settings.tsx", section: "SettingsSection",
    partB: [
  ...
  { phase: "Compositions", file: "packages/side-chat-widget/src/shared/ui/shell.tsx", section: "ShellSection",
    partB: [
...
function buildPrompt(c) {
  return [
    ...
    "=========== YOUR FILE ===========",
    "FILE: " + c.file,
    "REQUIRED section export: " + c.section,
    "",
    c.partB,
    "",
...
phase("Primitives");
log("Building " + primitives.length + " primitives (§8 + §10 markdown)…");
const primitiveResults = await parallel(
  primitives.map((c) => () =>
    agent(buildPrompt(c), {
      label: c.file.split("/").pop(),
      phase: "Primitives",
...
phase("Compositions");
log("Building " + compositions.length + " compositions (§9)…");
const compositionResults = await parallel(
  compositions.map((c) => () =>
    agent(buildPrompt(c), {
      label: c.file.split("/").pop(),
      phase: "Compositions",
...
const manifest = [...primitiveResults, ...compositionResults]
  .filter(Boolean)
  .map((m, i) => ({ kind: i < primitiveResults.length ? "primitive" : "composition", ...m }));

log("Built " + manifest.length + "/" + COMPONENTS.length + " component files.");
return { manifest, expected: COMPONENTS.map((c) => ({ file: c.file, section: c.section, phase: c.phase })) };
