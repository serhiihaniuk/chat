...
| Field          | Value                                                                                                                                                                                                          |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Owns           | Deployable service composition, HTTP routes, auth/config adapters, concrete runtime tool, turn guard, RAG retriever, research agent, and memory adapters, SSE conversion, concrete service ports and adapters. |
