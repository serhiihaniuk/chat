...
| **Boundaries enforced by CI, not convention.**                                                                  | 15 gate scripts parse every import and dependency; a forbidden import fails before review ([package-boundaries.md](../architecture/package-boundaries.md)).    | Boundary erosion, one well-meaning PR at a time.                                  |
