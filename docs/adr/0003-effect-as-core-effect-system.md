...
best guarantees exist *because* of these capabilities, and the review's worst
server bugs (stranded turns, silent listener death) came from the two places
that *bypassed* the discipline — an unobserved fiber and an `Effect.promise`
