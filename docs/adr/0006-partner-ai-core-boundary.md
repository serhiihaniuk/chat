...
Backend core is hexagonal and framework-free. It owns authority normalization, policy decisions, stream orchestration, typed errors, ports, observability services, and Effect runtime wiring.
