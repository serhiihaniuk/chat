...
— code, tests, docs, config — in the same patch. CI (`plan/13`) runs the
identical gate, closing the one hole the review found in this system: gates
that only run when someone remembers.
