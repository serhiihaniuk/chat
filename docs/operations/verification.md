...
| 13  | `check-generated-artifacts.mjs`          | Any file named `*.generated.*` has a registered generator and declares it; hand-maintained schema/OpenAPI files must not claim generated status.                                                                                                                                                          |
