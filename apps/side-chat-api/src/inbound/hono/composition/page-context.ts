...
export const createDefaultPageContext = (): PageContextPort => ({
  async resolve({ workspaceId }) {
    ...
    return {
      ...
      summary:
        "A single-page advisory dashboard for relationship, portfolio performance, advisory coverage, risk, and compliance review.",
      facts: [
        ...
        "The visual direction is restrained: white, charcoal, light gray dividers, and red accent.",
      ],
    };
  },
});
