...
export const resolveResumabilityConfig = (
  ...
  return {
    ...
    prunerIntervalMs: num(
      resumability?.prunerIntervalMs,
      RESUMABILITY_DEFAULTS.PRUNER_INTERVAL_MS,
    ),
    prunerBatchLimit: num(
      resumability?.prunerBatchLimit,
      RESUMABILITY_DEFAULTS.PRUNER_BATCH_LIMIT,
    ),
  };
};
